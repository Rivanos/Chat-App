...
if (isset($_SESSION['id'])) {
    ...
    if ($nb_checkIn->rowcount() == 1) {
        ...
        $nb = $dbh->query($sql);
        while($row = $nb->fetch()){
            echo '<p class="menu_interact"><a id="profile" data-toggle="modal" data-target="#modalPorfile"><img class="avatar" src="'.$row['path_avatar_user'].'" /></a></p>
            ...
            <h5>Changer votre Pseudonyme</h5>
            ...
            <hr />
            <h5>Changer la couleur de votre pseudo</h5>
